...
class ProductosController extends AppController
{
    ...
    public function view($id = null)
    {
        $producto = $this->Productos->get($id, [
            'contain' => ['ProductoTipos', 'AplicacionDetalles']
        ]);
    ...
    public function add()
    {
        ...
        $productoTipos = $this->Productos->ProductoTipos->find('list', ['limit' => 200]);
        $this->set(compact('producto', 'productoTipos'));
    }
