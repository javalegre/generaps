...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Arroz Tipo Curado'), ['action' => 'edit', $arrozTipoCurado->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Arroz Tipo Curado'), ['action' => 'delete', $arrozTipoCurado->id], ['confirm' => __('Are you sure you want to delete # {0}?', $arrozTipoCurado->id)]) ?> </li>
...
<div class="arrozTipoCurados view large-9 medium-8 columns content">
    <h3><?= h($arrozTipoCurado->id) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Nombre') ?></h4>
        <?= $this->Text->autoParagraph(h($arrozTipoCurado->nombre)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Tecnicas') ?></h4>
        <?php if (!empty($arrozTipoCurado->tecnicas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($arrozTipoCurado->tecnicas as $tecnicas): ?>
            <tr>
                <td><?= h($tecnicas->id) ?></td>
