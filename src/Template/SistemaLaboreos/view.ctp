...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Sistema Laboreo'), ['action' => 'edit', $sistemaLaboreo->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Sistema Laboreo'), ['action' => 'delete', $sistemaLaboreo->id], ['confirm' => __('Are you sure you want to delete # {0}?', $sistemaLaboreo->id)]) ?> </li>
...
<div class="sistemaLaboreos view large-9 medium-8 columns content">
    <h3><?= h($sistemaLaboreo->id) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Nombre') ?></h4>
        <?= $this->Text->autoParagraph(h($sistemaLaboreo->nombre)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Tecnicas') ?></h4>
        <?php if (!empty($sistemaLaboreo->tecnicas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($sistemaLaboreo->tecnicas as $tecnicas): ?>
            <tr>
                <td><?= h($tecnicas->id) ?></td>
